...
//   2. Run: npm run db:seed:vercel

import { PrismaClient } from '@prisma/client'

// Use environment variables from .env.local (pulled from Vercel)
...
console.log('📦 Using database:', databaseUrl.replace(/:[^:@]+@/, ':****@')) // Hide password
...
async function main() {
  console.log('🌱 Seeding Vercel database with mock data...')
  ...
  console.log(`\n🎉 Vercel database seeded successfully!`)
  console.log(`\n📊 Visit your Vercel app to see the data!`)
}
